...
mn_fp_arr = [0.05, 0.1, 0.15, 0.2, 0.5]#[0.0, 0.05, 0.1, 0.15, 0.2, 0.5]
...
for split_id in range(NUM_SPLITS_TO_READ):
    ...
    X_val_val, y_label_val, X_column_names, taxa_group_names_val = read_sporulat_data(data_filename_val, y_filename_val, taxa_names_filename_val, DEVICE)  
